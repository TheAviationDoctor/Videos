...
class Scene(MovingCameraScene):
    ...
    def construct(self):
        ...
        Text.set_default(font = "Montserrat", font_size = 32)
        ...
        phx_label = Text("PHX, June 2017", font_size = 20).next_to(phx, direction = RIGHT, buff = 0.15)
        ...
        self.wait(30)
        self.play(self.camera.auto_zoom(gr, margin = 3))
        self.play(FadeIn(li), runtime = 0)
        self.play(Transform(gr1, gr2), runtime = 3)

# Run with:
# manim -pqX code/manim/community/envelope-for-mro-asia.py Scene --disable_caching
# Replace X with pql for low quality (480p15), pqh for high quality (1080p60), pqk for 4K (2160p60)